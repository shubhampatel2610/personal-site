...
const ScrollProgressBar = () => {
  ...
  const progressInnerClasses = "h-full bg-blue-500 transition-all duration-100 ease-out";
...
const SectionDivider = () => {
  ...
  const dividerLineClasses = "w-full h-px";
...
const HomeSection = observer(() => {
  ...
  const pageBackgroundClasses = "fixed inset-0 pointer-events-none z-0";
  const glowTopClasses = "fixed top-0 left-1/2 -translate-x-1/2 pointer-events-none z-0";
  const pageSectionsClasses = "relative z-10";

  return (
    <div className={pageWrapperClasses} style={{ backgroundColor: "#0a0a0a" }}>
      <ScrollProgressBar />

      <div
        className={pageBackgroundClasses}
        style={{
