      ...
      <div className="fixed top-0 right-0 z-50 h-full w-72 flex flex-col bg-[#111111] border-l border-white/[0.06] shadow-[−8px_0_40px_rgba(0,0,0,0.6)] animate-[slideInRight_0.3s_cubic-bezier(0.4,0,0.2,1)_both]">
        ...
        <div className="flex items-center justify-between px-3 h-16 border-b border-white/[0.06]">
          ...
          <div className="flex items-center gap-2.5">
            <span className="flex items-center justify-center p-2.5 rounded-md bg-[#3B82F6]/10 border border-[#3B82F6]/20">
          ...
          <button
            ...
            className="flex items-center justify-center p-2 rounded-lg border border-white/[0.08] bg-white/[0.04] hover:bg-white/[0.08] hover:border-white/[0.15] text-[#a1a1aa] hover:text-white transition-all duration-200 cursor-pointer"
          >
