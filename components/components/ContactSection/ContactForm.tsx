...
const ContactForm = observer(() => {
  ...
  return (
    <div
      className="relative flex flex-col gap-5 p-3 md:p-5 rounded-xl
    ...
    >
      ...
      <span className="absolute top-0 left-8 right-8 h-[1px] rounded-full
        bg-gradient-to-r from-transparent via-[#3B82F6]/40 to-transparent" />

      {/* Form fields — store bindings untouched */}
      <InputTextComponent
      ...
      <Button
        ...
        className="w-full flex items-center justify-center gap-2 px-6 py-3 mt-1
