...
const SkillSection = () => {
  ...
  const blockTitleClasses = "text-white font-semibold text-base tracking-tight shrink-0";
  const blockLineClasses = "flex-1 h-[1px] bg-gradient-to-r from-white/[0.08] to-transparent";
      ...
      <div className={containerClasses}>
        <div className={headerClasses}>
          <div className={badgeClasses}>
            ...
            <span className={badgeLabelClasses}>Expertise</span>
          </div>
          <h2 className={titleClasses}>Skills & Tools</h2>
